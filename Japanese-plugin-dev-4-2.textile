...
今まで１５章に渡ってMTのプラグインの解説をしてきましたが、今回は必ずしもプラグインにする必要はありません。後々の事を考えプラグインとしてパッケージングします。
...
MT::Fooオブジェクトの一覧画面用テンプレート。アクセスURLは @http://www.example.com/cgi-bin/mt504/plugins/MyPlugin12/newapp.cgi?blog_id=2@ などして、アクセスします。（blog_id必須）
...
[[MyPlugin12.zip(4.35KB)|https://github.com/movabletype/Documentation/raw/master/assets/Japanese-plugin-dev/files/MyPlugin12.zip]]
