...
| m15 (Beta 3) | 2/28-3/18 | English string freeze | Fix release blockers | Regression test | English UI check (2) |  |  |
| m16 (Beta 4)  | 3/22-4/1 | L10N string freeze | Fix release blockers | Regression test<br />Security audit (2) | JA L10N (2)<br />EMEA L10N | |  |
| m17 (RC1) | 4/4-4/15 | *Code Freeze* | Complete development | Regression test |  | Prepare user guides |  |
| m18 (RC2) | 4/18-4/22 |  | Prepare developer guide (2) |  |  | |  |
| m19 (RC3) | 4/25-4/28 | Release Preparation | Publish developer guides (2)<br /> | Verify production builds |  | Update user guides |  |
| m20 (Final) | 5/9-5/11 | *Ship it !!!* |  |  |  |  |  |
