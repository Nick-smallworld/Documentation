...
| m12 | 1/17-1/28 |  | Prepare developer guides (1)<br />Clean up code | Smoke test<br />Bug fix confirmation | -English UI check (1)- skipped to m13 | Prepare beta user guide (1) |Done  |
| m13 (Beta 1) | 1/31-2/11 | *Beta Ready* | Prepare developer guides (1)<br />Clean up code | Smoke test<br />Verify Beta builds | English UI check (1) | Prepare beta user guide (1) |Done  |
| | 2/11 | *Review pull/patch requests (1)*  | Review patches | Bug triage | | | |
| | 2/15 | *Release Beta 1*  |  | | |  Publish beta post | |
| m14 (Beta 2) | 2/14-2/25 |  | Clean up code | Regression test<br />Upgrade test<br />Security audit (1) | JA L10N (1) | |  |
